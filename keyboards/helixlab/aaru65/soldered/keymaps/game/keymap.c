...
#define GAM_MOD  GAME_MODE

static bool game_mode = 0;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_FN] = LAYOUT_all(
        ...
        _______, FAD_TOG, FAD_REV, _______, _______, GAM_MOD, _______, _______, _______, _______, _______, _______, _______, _______,
